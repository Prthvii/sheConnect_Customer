...
class SheTrusted extends StatefulWidget {
  const SheTrusted({Key? key}) : super(key: key);

  @override
  _SheTrustedState createState() => _SheTrustedState();
}

class _SheTrustedState extends State<SheTrusted> {
  @override
    ...
    return Column(
      ...
      children: [
        ...
        const Text("Bestima Cotton Bedsheeaa ansj abnxsjx xasxbn...",
            maxLines: 1, overflow: TextOverflow.ellipsis, style: size14_700),
        Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Text(rs + "399", style: size16_400),
